      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={paragraph}>
            Welcome to Craft<samp className="text-blue-600">Sync</samp>, Elevate
            creativity with seamless collaboration. Effortless video syncing for
            your content creation joureny.
          </Text>
